...
*   **Clarksfield**——英特尔酷睿（Core）i7移动处理器系列——45纳米处理器制造工艺
    *   4 physical cores
...
Many Skylake-based processors are not yet listed in this section: mobile i3/i5/i7 processors (U, H, and M suffixes), embedded i3/i5/i7 processors (E suffix), certain i7-67nn/i7-68nn/i7-69nn.[[4]](#cite_note-4) Skylake-based "Core X-series" processors (certain i7-78nn and i9-79nn models) can be found under current models.
...
*   2009: [Single-chip Cloud Computer], a research microprocessor containing the most Intel Architecture cores ever integrated on a silicon CPU chip – 48 cores.
...
| 80548    | _canceled_                                                   | [Tejas and Jayhawk]                                          |
...
| 80647    | Core i5/i7 – 4xxxM                                           | [Haswell-H, Haswell-M]                                  |
...
| 80667    | [Xeon Phi]                                                   | Knights Landing                                         |
